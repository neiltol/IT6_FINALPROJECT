...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['photo']['name'])) {
        ...
        $hashed_password = md5($default_password); // Hash it like your existing members
        ...
        $insertQuery = "INSERT INTO members (fullname, dob, gender, contact_number, email, password, address, country, postcode, occupation, 
                        ...
                        VALUES ('$fullname', '$dob', '$gender', '$contactNumber', '$email', '$hashed_password', '$address', '$country', '$postcode', '$occupation', 
